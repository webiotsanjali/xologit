...
function submitBookMark() {
	...
	$('#index_var').val(parseInt(index_var)+1);
		...
		var bmColData = '<div class="col-xl-3 col-md-4 xl-50">\
	      <div class="card card-with-border bookmark-card o-hidden"><div class="details-website"><img class="img-fluid" src="../assets/images/lightgallry/07.jpg" alt="" data-original-title="" title="">\
	        <div class="favourite-icon" id="favourite_'+index_var+'" onclick="setFavourite('+index_var+')"><a href="#" data-original-title="" title=""><i class="fa fa-star"></i></a></div>\
	        <div class="title-bookmark">\
	          <h6 id="title_'+index_var+'">'+title+'</h6>\
	          <div class="hover-block">\
	            <p id="weburl_'+index_var+'">'+weburl+'</p>\
	            <ul>\
	              <li><a href="#">\
...
function setFavourite(index_var){
	...
	if(n){
		...
		var bmColData = '<div class="col-xl-3 col-md-4 xl-50" id="favourite_card_'+index_var+'">\
	      <div class="card card-with-border bookmark-card o-hidden"><div class="details-website"><img class="img-fluid" src="../assets/images/lightgallry/07.jpg" alt="" data-original-title="" title="">\
	        <div class="favourite-icon favourite" id="favourite_'+index_var+'" onclick="setFavourite('+index_var+')"><a href="#" data-original-title="" title=""><i class="fa fa-star"></i></a></div>\
	        <div class="title-bookmark">\
	          <h6 id="title_'+index_var+'">'+title+'</h6>\
	          <div class="hover-block">\
	            <p id="weburl_'+index_var+'">'+weburl+'</p>\
